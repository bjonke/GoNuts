...
#define WAV_PATH "Morph.wav"
#define POSITIVE_OGG_PATH "positive.ogg"
#define NEGATIVE_OGG_PATH "negative.ogg"
#define MUS_PATH "race-duel-short.wav"
...
return -1;
    ...
    SDL_Surface* surface = IMG_Load( "./atari.png" );
    ...
    SDL_Surface * BadAcornsBMP = IMG_Load("BadAcorns.png");//SDL_LoadBMP("BadAcorns.bmp");
    SDL_Texture * BadAcornsTexture = SDL_CreateTextureFromSurface(renderer, BadAcornsBMP);
    SDL_FreeSurface(BadAcornsBMP);

    SDL_Surface * BadgerBMP = IMG_Load("Badger.png");//SDL_LoadBMP("Badger.bmp");
    ...
    while (!quit)
    {
        ...
        BackgroundTexture = LoadTexture("./atari-abstract-clouds.jpg");
